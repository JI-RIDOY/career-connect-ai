...
const Network = () => {
  ...
  const loadAllUsers = async () => {
    try {
      const response = await fetch('https://ai-server-1-ckgg.onrender.com/api/users');
          ...
          data.users
            ...
            .map(async (userItem) => {
              const statusResponse = await fetch(
                `https://ai-server-1-ckgg.onrender.com/api/connections/status/${user.uid}/${userItem.uid}`
              );
  ...
  const loadConnections = async () => {
    try {
      const response = await fetch(`https://ai-server-1-ckgg.onrender.com/api/connections/user/${user.uid}?status=accepted`);
      const data = await response.json();
  ...
  const loadPendingRequests = async () => {
    try {
      const response = await fetch(`https://ai-server-1-ckgg.onrender.com/api/connections/pending/${user.uid}`);
      const data = await response.json();
  ...
  const loadSentRequests = async () => {
    try {
      const response = await fetch(`https://ai-server-1-ckgg.onrender.com/api/connections/sent/${user.uid}`);
      const data = await response.json();
  ...
  const loadSuggestions = async () => {
    try {
      const response = await fetch(`https://ai-server-1-ckgg.onrender.com/api/connections/suggestions/${user.uid}`);
      const data = await response.json();
      ...
      if (data.success) {
        const suggestionsWithStatus = await Promise.all(
          data.suggestions.map(async (suggestion) => {
            const statusResponse = await fetch(
              `https://ai-server-1-ckgg.onrender.com/api/connections/status/${user.uid}/${suggestion.uid}`
            );
            const statusData = await statusResponse.json();
  ...
  const loadStats = async () => {
    try {
      const response = await fetch(`https://ai-server-1-ckgg.onrender.com/api/connections/stats/${user.uid}`);
      const data = await response.json();
  ...
  const loadProfessions = async () => {
    try {
      const response = await fetch('https://ai-server-1-ckgg.onrender.com/api/users/professions');
      const data = await response.json();
  ...
  const sendConnectionRequest = async (receiverId) => {
    try {
      const response = await fetch('https://ai-server-1-ckgg.onrender.com/api/connections/send-request', {
        method: 'POST',
        headers: {
  ...
  const acceptConnectionRequest = async (requestId) => {
    try {
      const response = await fetch(`https://ai-server-1-ckgg.onrender.com/api/connections/accept-request/${requestId}`, {
        method: 'POST',
      });
  ...
  const rejectConnectionRequest = async (requestId) => {
    try {
      const response = await fetch(`https://ai-server-1-ckgg.onrender.com/api/connections/reject-request/${requestId}`, {
        method: 'POST',
      });
  ...
  const withdrawConnectionRequest = async (requestId) => {
    try {
      const response = await fetch(`https://ai-server-1-ckgg.onrender.com/api/connections/withdraw-request/${requestId}`, {
        method: 'DELETE',
      });
  ...
  const removeConnection = async (connectionId) => {
    try {
      const response = await fetch(`https://ai-server-1-ckgg.onrender.com/api/connections/remove-connection/${connectionId}`, {
        method: 'DELETE',
      });
