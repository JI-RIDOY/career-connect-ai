...
const Network = () => {
  ...
  const tabs = [
    { id: 'all', label: 'All Users', icon: FaUsers, count: connections.length },
    ...
    >
      <div className="flex items-start space-x-4">
        ...
        <div className="flex-shrink-0">
          <div className="w-16 h-16 rounded-xl overflow-hidden bg-gradient-to-br from-blue-100 to-blue-50">
            {user.photoURL ? (
              <img
                src={user.photoURL}
        ...
        <div className="flex flex-col space-y-2">
          ...
          {!isRequest && !user.connectionStatus && (
            <button
              ...
              className="flex items-center justify-center px-4 py-2 bg-blue-500 text-white rounded-xl text-sm font-semibold hover:bg-blue-600 transition-colors hover:shadow-lg hover:shadow-blue-500/25"
            >
