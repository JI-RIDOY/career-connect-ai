...
const PaymentModal = ({ isOpen, onClose, plan, billingCycle, user, onPaymentSuccess }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await fetch('https://ai-server-1-ckgg.onrender.com/api/payments/create-payment-intent', {
                method: 'POST',
                headers: {
            ...
            if (result.error) {
                ...
                const confirmResponse = await fetch('https://ai-server-1-ckgg.onrender.com/api/payments/confirm-payment', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
