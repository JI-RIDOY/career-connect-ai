...
const ATSScoreCheck = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://ai-server-sable.vercel.app/api/ats/check-score', {
        method: 'POST',
        body: formData,
      });
  ...
  const fetchScoreHistory = async () => {
    ...
    try {
      const response = await fetch(`https://ai-server-sable.vercel.app/api/ats/history/${user.email}`);
      const data = await response.json();
