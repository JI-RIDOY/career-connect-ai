...
const CreatePostModal = React.memo(({ isOpen, onClose, onSuccess }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const res = await fetch('https://ai-server-1-ckgg.onrender.com/api/posts', {
                method: 'POST',
...
const FeedContent = () => {
    ...
    const handleLike = async (postId) => {
        ...
        try {
            const res = await fetch(`https://ai-server-1-ckgg.onrender.com/api/posts/${postId}/like`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const handleAddComment = async (postId) => {
        ...
        try {
            const res = await fetch(`https://ai-server-1-ckgg.onrender.com/api/posts/${postId}/comment`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    userId: user.uid,
    ...
    const handleDeletePost = async (postId) => {
        ...
        try {
            await fetch(`https://ai-server-1-ckgg.onrender.com/api/posts/${postId}`, {
                method: 'DELETE',
                headers: { 'Content-Type': 'application/json' },
